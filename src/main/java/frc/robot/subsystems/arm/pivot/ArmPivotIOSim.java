...
public class ArmPivotIOSim implements ArmPivotIO {
    ...
    private ArmFeedforward armFF = new ArmFeedforward(0.3, 0.5, 0);
    private ArmFeedforward wristFF = new ArmFeedforward(0.3, 0.5, 0);

    private PIDController armPid = new PIDController(3, 0, 0);
    private PIDController wristPid = new PIDController(3, 0, 0);
